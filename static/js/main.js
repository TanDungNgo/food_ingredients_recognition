    ...
    return `
            <div class="recipe-container-detailed">
                <div class="recipe-container-header">
                    ...
                    Dish Name : ${
                      recipeInfo.title
                    } <b style="color: black,font-size: 30px;"></b></h1>
                ...
                <div class="recipe-container-body">
                    ...
                    <div class="recipe-container-container">
                        <h2>Recipe link  🔪: 
                            ...
                            }" target="_blank">${recipeInfo.spoonacularSourceUrl}</a>
                        </h2>
                    </div>
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        data.results_list.forEach((result) => {
          const listItem = $('<div class="result-item"></div>').text(
            `${result}`
          );
